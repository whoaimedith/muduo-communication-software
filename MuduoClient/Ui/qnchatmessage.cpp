...
QNChatMessage::QNChatMessage(QWidget *parent) : QWidget(parent)
{
    ...
    te_font.setFamily("Times New Roman");
  ...
  // te_font.setLetterSpacing(QFont::PercentageSpacing,0);
    ...
    m_leftPixmap = QPixmap(":/image/Resouces/Customer Copy.png");
    m_rightPixmap = QPixmap(":/image/Resouces/CustomerService.png");

    m_loadingMovie = new QMovie(this);
    m_loadingMovie->setFileName(":/image/Resouces/loading4.gif");
